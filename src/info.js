class Bioma {
    ...
    acomodaAnimais(animais, quantidade) {
        ...
        recintos.forEach(recinto => {
            const compatibilidadeBiomaAnimal = recinto.nome.toLowerCase().includes(animalControle.bioma.toLowerCase()) ||
                (animalControle.biomaSecundario && recinto.nome.toLowerCase().includes(animalControle.biomaSecundario.toLowerCase()));

            if (!compatibilidadeBiomaAnimal) return;
        ...
        if (recintosViaveis.length === 0) {
            return new ErroZoo("Não há recinto viável");
        }
...
class Animais {
    constructor(nome) {
        switch (nome) {
            case "LEAO":
                this.nome = nome; this.tamanho = 3; this.bioma = "savana"; this.comportamentoAlimentar = "Carnívoro"; break;

            case "LEOPARDO":
                this.nome = nome; this.tamanho = 2; this.bioma = "savana"; this.comportamentoAlimentar = "Carnívoro"; break;

            case "CROCODILO":
                this.nome = nome; this.tamanho = 3; this.bioma = "rio"; this.comportamentoAlimentar = "Carnívoro"; break;

            case "MACACO":
                this.nome = nome; this.tamanho = 1; this.bioma = "savana"; this.biomaSecundario = "floresta"; this.comportamentoAlimentar = "Onívoro"; break;

            case "GAZELA":
                this.nome = nome; this.tamanho = 2; this.bioma = "savana"; this.comportamentoAlimentar = "Herbívoro"; break;

            case "HIPOPOTAMO":
                this.nome = nome; this.tamanho = 4; this.bioma = "savana"; this.biomaSecundario = "rio"; this.comportamentoAlimentar = "Herbívoro"; break;

            default:
                return new ErroZoo("Animal inválido");
        }
    }
}
    ...
    constructor(nome) {
        switch (nome) {
            case "Animal inválido":
                this.erro = "Animal inválido"; this.recintosViaveis = false; break;
            case "Quantidade inválida":
                this.erro = "Quantidade inválida"; this.recintosViaveis = false; break;
            case "Não há recinto viável":
                this.erro = "Não há recinto viável"; this.recintosViaveis = false; break;
